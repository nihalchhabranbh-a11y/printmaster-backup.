  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-32">
        ...
        <section className="pt-24 pb-20 text-center">
          <div className="max-w-5xl mx-auto px-6">
            <div className="flex flex-col items-center">
              <motion.div {...fadeUp(0)}>
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-indigo-500/30 bg-indigo-500/10 text-indigo-500 text-xs font-medium mb-8">
        ...
        {/* RATINGS BANNER */}
        <section className="py-14 border-y border-border/40 bg-gradient-to-r from-indigo-500/5 via-violet-500/5 to-indigo-500/5">
        ...
        {/* PRICING */}
        <section id="pricing" className="py-20 bg-gradient-to-b from-transparent via-secondary/10 to-transparent">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col items-center text-center mb-12">
              <motion.div {...fadeUp()}>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {PLANS.map(({ name, price, period, highlight, features, cta }, i) => (
                <motion.div key={name} {...fadeUp(i * 0.1)}>
                  <div className={`relative h-full rounded-2xl border p-8 flex flex-col ${highlight
                    ? "border-indigo-500/60 bg-gradient-to-b from-indigo-500/10 to-violet-500/5 shadow-2xl shadow-indigo-500/15"
          ...
          <div className="max-w-4xl mx-auto px-6">
            <motion.div {...fadeUp()}>
              <div className="relative rounded-3xl overflow-hidden border border-indigo-500/25 bg-gradient-to-br from-indigo-500/10 via-card to-violet-500/10 p-12 text-center">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-indigo-500/30 bg-indigo-500/10 text-indigo-500 text-xs font-medium mb-6">
                  <Zap className="w-3.5 h-3.5" />
                  Free to start, no credit card needed
                </div>
                <h2 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight text-balance">Ready to grow your business?</h2>
